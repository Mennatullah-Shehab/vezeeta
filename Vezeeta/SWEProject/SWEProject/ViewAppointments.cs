...
namespace SWEProject
{
    public partial class ViewAppointments : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string cmdstr = " select distinct D.dname from Doctor D, Appointment app where app.pat_id =:pid and d.dr_id=app.dr_id";
        ...
        {
            string constr = "Data Source=orcl; User Id=scott; Password=tiger;";
            string cmdstr = " select D.dname , app.time from Doctor D, Appointment app, Patient p where  app.pat_id =:pid and app.pat_id = p.pat_id and D.dname =:dName and D.dr_id=app.dr_id ";
            adapter = new OracleDataAdapter(cmdstr, constr);
            adapter.SelectCommand.Parameters.Add("pid", CreateAccount.pat_id);
        ...
        private void updateprf_btn_Click(object sender, EventArgs e)
        {
            OracleCommandBuilder builder = new OracleCommandBuilder(adapter);
            adapter.Update(Ds.Tables[0]);
        }

        private void showappts_btn_Click(object sender, EventArgs e)
        {
